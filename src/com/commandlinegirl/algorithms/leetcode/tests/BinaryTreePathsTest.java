...
import com.commandlinegirl.algorithms.leetcode.BinaryTreePaths;
...
public class BinaryTreePathsTest {
    ...
    public void testPrintPaths1() {
        ...
        List<String> paths = b.binaryTreePathsRec1(n6);
        List<String> res = Arrays.asList(
                ...
                "6->2->4->3",
                 "6->2->0");
        Assert.assertEquals(res, paths);
    }

    @Test
    public void testPrintPaths2() {
        BinaryTreePaths b = new BinaryTreePaths();
        List<String> paths = b.binaryTreePathsRec2(n6);
        List<String> res = Arrays.asList(
                "6->8->9",
                "6->8->7",
                "6->2->4->5",
    ...
    @Test
    public void testPrintPaths3() {
        BinaryTreePaths b = new BinaryTreePaths();
        List<String> paths = b.binaryTreePathsStack1(n6);
        List<String> res = Arrays.asList(
                "6->8->9",
                "6->8->7",
                "6->2->4->5",
